"""cigapp_18162 URL Configuration
...
admin.site.site_header = "Cigapp"
admin.site.site_title = "Cigapp Admin Portal"
admin.site.index_title = "Cigapp Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Cigapp API",
        default_version="v1",
        description="API documentation for Cigapp App",
    ),
    public=True,
